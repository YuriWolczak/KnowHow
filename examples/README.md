...
Os exemplos são complementares aos exercícios de lógica em [fundamentals/exercises](../fundamentals/exercises/README.md). A implementação em uma linguagem concreta deve preservar o algoritmo, mas pode explorar as características próprias da linguagem.
